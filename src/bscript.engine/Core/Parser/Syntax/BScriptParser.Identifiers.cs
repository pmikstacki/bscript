...
{
    internal static Parser<Expression> ElseInvalidType( this Parser<Expression> parser ) => parser.ElseError( BScriptParser.InvalidTypeMessage );
    internal static Parser<Expression> ElseInvalidExpression( this Parser<Expression> parser ) => parser.ElseError( BScriptParser.InvalidExpressionMessage );
    internal static Parser<Expression> ElseInvalidStatement( this Parser<Expression> parser ) => parser.ElseError( BScriptParser.InvalidStatementMessage );
    internal static Parser<TextSpan> ElseInvalidIdentifier( this Parser<TextSpan> parser ) => parser.ElseError( BScriptParser.InvalidIdentifier );
}

...
public class XsParserExpressionTests
{
    ...
    {
        var expression = BScript.Parse( "5;" );
    ...
    {
        var expression = BScript.Parse( "-1 + 3;" );
    ...
    {
        var expression = BScript.Parse( "!false;" );
    ...
    {
        var expression = BScript.Parse( "?true;" );
    ...
    {
        var expression = BScript.Parse( "10 + 12;" );
    ...
    {
        var expression = BScript.Parse( "10 + 12 + 14;" );
    ...
    {
        var expression = BScript.Parse( "(10 + 12) * 2;" );
    ...
    {
        var expression = BScript.Parse( "(10 + 12) * (1 + 1);" );
    ...
    {
        var expression = BScript.Parse( "10 < 11;" );
    ...
    {
        var expression = BScript.Parse( "2 ** 3;" );
    ...
    {
        var expression = BScript.Parse( "(2 + 3) ** 2;" );

...
public class XsParserLiteralTests
{
    ...
    {
        var expression = BScript.Parse( "\"Some String\";" );
    ...
    {
        var expression = BScript.Parse( "var x = 'c';" );
    ...
    {
        var expression = BScript.Parse( "var x = 12345;" );
    ...
    {
        var expression = BScript.Parse( "var x = 12345N;" );
        var lambda = Lambda<Func<int>>( expression );
    ...
    {
        var expression = BScript.Parse( "var x = 12345L;" );
    ...
    {
        var expression = BScript.Parse( "var x = 123.45F;" );
    ...
    {
        var expression = BScript.Parse( "var x = 123.45D;" );
    ...
    {
        var expression = BScript.Parse( "123.45D;" );
        var lambda = Lambda<Func<double>>( expression );
    ...
    {
        var expression = BScript.Parse( "123.45D.ToString();" );
        var lambda = Lambda<Func<string>>( expression );
    ...
    {
        var expression = BScript.Parse( "(123.45D + 7D).ToString();" );
        var lambda = Lambda<Func<string>>( expression );
    ...
    {
        var expression = BScript.Parse( "var x = 12345L as int;" );
        var lambda = Lambda<Func<int>>( expression );
    ...
    {
        var expression = BScript.Parse( "var x = 12345L as? long;" );
        var lambda = Lambda<Func<long?>>( expression );
    ...
    {
        var expression = BScript.Parse( "var x = 12345L as? int ?? 10;" );
        var lambda = Lambda<Func<int>>( expression );
    ...
    {
        var expression = BScript.Parse( "12345L is long;" );

...
public class XsParserVariableTests
{
    ...
    {
        var expression = BScript.Parse( "var x = 10;" );
    ...
    {
        var expression = BScript.Parse( "var x = 10; x + 10;" );
    ...
    {
        var expression = BScript.Parse( "var x = 10; x = x + 10; x + 22;" );
    ...
    {
        var expression = BScript.Parse( "var x = 32; x <<= 2; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 8; x >>= 2; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 10; x++;" );
    ...
    {
        var expression = BScript.Parse( "var x = 10; x += 32; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 42; x -= 32; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 10; x *= 4; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 40; x /= 4; x;" );
    ...
    {
        var expression = BScript.Parse( "var x = 2; x **= 3; x;" );
    ...
    public void Compile_ShouldSucceed_WithPropertyAssignment( CompilerType compiler )
    {
        ...
        var expression = BScript.Parse(
            """
            var x = new bscript.Tests.TestClass(21);
            x.PropertyValue *= 2;
            x.MethodValue();
            """ );
    ...
    public void Compile_ShouldSucceed_WithPropertyComplexAssignment( CompilerType compiler )
    {
        ...
        var expression = BScript.Parse(
            """
            var x = new bscript.Tests.TestClass(5);
    ...
    public void Compile_ShouldAllowDoubleAssignment( CompilerType compiler )
    {
        ...
        var expression = BScript.Parse( xs );
